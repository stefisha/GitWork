      ...
      <div className="max-w-2xl w-full">
        ...
        >
          {submitStatus === 'success' && (
            <div className="mb-4 sm:mb-6 p-3 sm:p-4 rounded-lg" style={{ background: '#1a472a', border: '1px solid #238636' }}>
          ...
          {submitStatus === 'error' && (
            <div className="mb-4 sm:mb-6 p-3 sm:p-4 rounded-lg" style={{ background: '#5d1a1a', border: '1px solid #da3633' }}>
          ...
          <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4 md:space-y-6">
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full px-3 py-2 sm:px-4 sm:py-3 rounded-lg text-sm sm:text-base text-white placeholder-gray-400 bg-transparent border border-gray-600 focus:outline-none focus:border-purple-500 transition-colors duration-200"
            ...
            {/* Subject */}
            <div>
              <label htmlFor="subject" className="block text-xs sm:text-sm font-medium text-white mb-1 sm:mb-2">
                Subject *
              </label>
              <input
                type="text"
            ...
            <div>
              ...
              <textarea
                ...
                required
                rows={4}
                className="w-full px-3 py-2 sm:px-4 sm:py-3 rounded-lg text-sm sm:text-base text-white placeholder-gray-400 bg-transparent border border-gray-600 focus:outline-none focus:border-purple-500 transition-colors duration-200 resize-none"
            ...
            <div className="pt-1 sm:pt-2">
              <button
                ...
                className="w-full px-4 py-2 sm:px-6 sm:py-3 rounded-lg font-semibold text-sm sm:text-base text-white transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
